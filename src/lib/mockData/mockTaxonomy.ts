...
export const AMENITIES_LIST: PropertyAmenity[] = [
  { id: 'piscina', name: 'Piscina', category: 'lazer', icon: 'Waves' },
  { id: 'churrasqueira', name: 'Churrasqueira', category: 'lazer', icon: 'Flame' },
  { id: 'academia', name: 'Academia Completa', category: 'lazer', icon: 'Dumbbell' },
  { id: 'quadra_tenis', name: 'Quadra', category: 'lazer', icon: 'Trophy' },
  ...
  { id: 'espaco_gourmet', name: 'Sala de Jogos', category: 'lazer', icon: 'Gamepad2' },
  ...
  { id: 'alarme', name: 'Bicicletário', category: 'estrutura', icon: 'Bike' },
